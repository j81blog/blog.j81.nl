---
title: "Let's Encrypt Certificates on a NetScaler"
date: 2017-04-06T21:25:51Z
...
There are [limits](https://letsencrypt.org/docs/rate-limits/) in place, that's why there is a "staging" (test) environment is available. You can use this server to test and make sure the circle can be completed before you use the Production server to get the "real" (trusted) certificates. These staging certificates are not publicly trusted. Some [rate limits](https://letsencrypt.org/docs/rate-limits/) to take into consideration:
...
More info about rate limits can be found [here](https://letsencrypt.org/docs/rate-limits/) But enough talked about LE, here are the parameters you need to run this script:
...
And the PowerSchell Script (GenLeCertForNS.ps1), you can also find it on GitHub: <a href="https://github.com/j81blog/GenLeCertForNS" target="_blank" rel="noopener noreferrer">https://github.com/j81blog/GenLeCertForNS</a>
...
Edit (08-04-2017, v0.6): Removed 2 bugs from the script. Also it currently only supports ipv4 Edit (10-04-2017, v0.7): Changed the "Load Module" region, to also run smoothly on an Server OS, and removed a bug. (Thank you [@MartinZugec](https://twitter.com/MartinZugec) for helping me with this one) Edit (23-04-2017, v0.7.1): Changed the "Load Module" region, [sometimes](https://github.com/ebekker/ACMESharp/issues/159) the -AllowClobber parameter is needed when installing modules. Let me know if you have issues with it or have some ideas. Edit (9-11-2017, v0.8.1): Added the script on GitHub, <https://github.com/j81blog/GenLeCertForNS> Edit (24-06-2018, v0.9.4): Fixed some issues in the scipt, merged dev branch into master.
